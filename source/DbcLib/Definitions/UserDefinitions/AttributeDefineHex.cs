...
{
    public class AttributeDefineHex : AttributeDefine
    {
        private Int64 max;
        public Int64 Max
        {
        ...
        public AttributeDefineHex(Dbc dbc, string name, ObjectType objectType, Int64 max = 0, Int64 min = 0) : base(dbc, name, objectType)
        {
            this.max = max;
            this.min = min;
        }
        internal override bool SetValueValid(object value)
        {
            ...
            //            if (!((Int64)value >= min && (Int64)value <= max))
            //            {
            //#if DEBUG
